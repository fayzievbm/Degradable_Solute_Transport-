...
def progonka():
    ...
    #c[nn - 1, j] = 0  # (F+A*bet[nn-1])/(B-A*alpha[nn-1])
...
#modul2.grafik3cp1(x,c11,1e3*ca11,1e3*cp11,c2,1e3*ca2,1e3*cp2,c3,1e3*ca3,1e3*cp3,tm,tau,nk)
#modul2.grafik3lep(x,c11,1e3*ca11,1e3*cp11,c2,1e3*ca2,1e3*cp2,c3,1e3*ca3,1e3*cp3,tm,tau,nk)
#modul2.grafik3le2(x,c11,1e3*ca11,1e3*cp11,c2,1e3*ca2,1e3*cp2,c3,1e3*ca3,1e3*cp3,tm,tau,nk)
#modul2.grafik3le1(x,c11,1e3*ca11,1e3*cp11,c2,1e3*ca2,1e3*cp2,c3,1e3*ca3,1e3*cp3,tm,tau,nk)
...
#7-rasm
#modul2.grafik3bar(x,c11,1e3*ca11,1e3*cp11,c2,1e3*ca2,1e3*cp2,c3,1e3*ca3,1e3*cp3,tm,tau,nk)
#modul2.grafik3bad(x,c11,1e3*ca11,1e3*cp11,c2,1e3*ca2,1e3*cp2,c3,1e3*ca3,1e3*cp3,tm,tau,nk)
#modul2.grafik3bar(x,c11,1e3*ca11,1e3*cp11,c2,1e3*ca2,1e3*cp2,c3,1e3*ca3,1e3*cp3,tm,tau,nk)
#modul2.grafik3v(x,c11,1e3*ca11,1e3*cp11,c2,1e3*ca2,1e3*cp2,c3,1e3*ca3,1e3*cp3,tm,tau,nk)
...
#modul.grafik3bp0t(N1,tt,c11,1e5*ca11,1e5*cp11,c2,1e5*ca2,1e5*cp2,c3,1e5*ca3,1e5*cp3,tm)
...
#modul2.grafik3le(x,c11,1e5*ca11,1e5*cp11,c2,1e5*ca2,1e5*cp2,c3,1e5*ca3,1e5*cp3,tm,tau,nn)
